...
<body>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h1 class="panel-title">SpringBootDemo</h1>
		</div>
	</div>
	<!-- 第一部分，搜索框和按钮 -->
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-offset-2">
				<div class="input-group">
					<input type="text" class="form-control empName_serach_input"
						id="empName_serach_input" placeholder="请输入员工姓名进行搜索"> <span
						class="input-group-btn">
						<button class="btn btn-default" type="button" id="serach_btn">
					...
					<div class="col-md-12 col-md-offset-8">
						<button class="btn btn-info btn-sm" id="emp_add_modal_btn">
	...
	<script type="text/javascript">
		...
		$("#serach_btn").click(function() {
			...
			//发送ajax请求，查出部门信息，显示在下拉列表中
			var empName = $("#empName_serach_input").val();
			getEmpsByName(empName);

		});

		function getEmpsByName(empName) {
			$.ajax({
				url : "${APP_PATH}/queryEmpsByName?empName=" + empName,
				type : "GET",
				success : function(result) {
					//console.log(result);
					build_emps_table(result)
